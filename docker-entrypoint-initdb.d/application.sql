...
--
-- Host: mysql_db
-- Generation Time: Jun 05, 2020 at 08:50 AM
...
(4, 'db_model_strapi_webhooks', '{\"name\":{\"type\":\"string\"},\"url\":{\"type\":\"text\"},\"headers\":{\"type\":\"json\"},\"events\":{\"type\":\"json\"},\"enabled\":{\"type\":\"boolean\"}}', 'object', NULL, NULL),
...
(1, 'admin', 'developer@1minus1.com', '$2a$10$CL1F6VWS0puVWPFacxtNtuMYen1yX7V/uMbk5pqyEZCGeRVb6RvdW', NULL, NULL);
...
(3, 'content-manager', 'components', 'listcomponents', 0, '', 2),
(4, 'content-manager', 'components', 'updatecomponent', 0, '', 1),
(5, 'content-manager', 'components', 'listcomponents', 0, '', 1),
(6, 'content-manager', 'contentmanager', 'checkuidavailability', 0, '', 1),
(7, 'content-manager', 'components', 'updatecomponent', 0, '', 2),
...
(122, 'users-permissions', 'userspermissions', 'deleteprovider', 0, '', 2),
(123, 'users-permissions', 'userspermissions', 'deleterole', 0, '', 1),
(124, 'users-permissions', 'userspermissions', 'deleterole', 0, '', 2),
...
(130, 'users-permissions', 'userspermissions', 'getpermissions', 0, '', 2),
(131, 'users-permissions', 'userspermissions', 'getpolicies', 0, '', 1),
(132, 'users-permissions', 'userspermissions', 'getpolicies', 0, '', 2),
(133, 'users-permissions', 'userspermissions', 'getproviders', 0, '', 1),
(134, 'users-permissions', 'userspermissions', 'getproviders', 0, '', 2),
(135, 'users-permissions', 'userspermissions', 'getrole', 0, '', 1),
(136, 'users-permissions', 'userspermissions', 'getrole', 0, '', 2),
(137, 'users-permissions', 'userspermissions', 'getroles', 0, '', 1),
(138, 'users-permissions', 'userspermissions', 'getroles', 0, '', 2),
(139, 'users-permissions', 'userspermissions', 'getroutes', 0, '', 1),
(140, 'users-permissions', 'userspermissions', 'getroutes', 0, '', 2),
(141, 'users-permissions', 'userspermissions', 'index', 0, '', 1),
(142, 'users-permissions', 'userspermissions', 'index', 0, '', 2),
(143, 'users-permissions', 'userspermissions', 'init', 1, '', 1),
(144, 'users-permissions', 'userspermissions', 'init', 1, '', 2),
(145, 'users-permissions', 'userspermissions', 'searchusers', 0, '', 1),
(146, 'users-permissions', 'userspermissions', 'searchusers', 0, '', 2),
(147, 'users-permissions', 'userspermissions', 'updateadvancedsettings', 0, '', 1),
(148, 'users-permissions', 'userspermissions', 'updateadvancedsettings', 0, '', 2),
(149, 'users-permissions', 'userspermissions', 'updateemailtemplate', 0, '', 1),
(150, 'users-permissions', 'userspermissions', 'updateemailtemplate', 0, '', 2),
(151, 'users-permissions', 'userspermissions', 'updateproviders', 0, '', 1),
(152, 'users-permissions', 'userspermissions', 'updateproviders', 0, '', 2),
(153, 'users-permissions', 'userspermissions', 'updaterole', 0, '', 1),
(154, 'users-permissions', 'userspermissions', 'updaterole', 0, '', 2);
